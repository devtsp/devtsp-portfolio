...
const About = () => {
	return (
		<div id="About">
			...
			<p>
				Constantly working on different kind of projects to keep learning new
				technologies and strengthen my programming fundamentals.
			</p>
			<p>
				...
				principles wherever I can.
			</p>
			<p>
				My philosophy is to try to be the one who knows the least in the room;
				so I can grow and learn from the ones with greater experience around me.
			</p>
